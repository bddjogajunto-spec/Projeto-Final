...
@when("abre o produto e clicar em excluir")
...
@then("verá mensagem de produto excluído")
def step_impl(context):
    ...
    if context.passou == False:
        ...
        evidencia(context=context, nome='Exclusao_produto_FALHA_nao_abriu_informacoes')
        print(f"\n❌ FALHA: Não foi possível abrir as informações do produto")
        print(f"Requisito que inspirou este teste RF0008\n")
